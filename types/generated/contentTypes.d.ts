...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    aboutContent: Schema.Attribute.String;
    ...
    whyChooseItems: Schema.Attribute.Component<'shared.why-choose-item', true>;
  };
}
...
export interface ApiAnnouncementAnnouncement
  ...
  attributes: {
    ...
    formLink: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    noticePDF: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
...
export interface ApiTeamMemberTeamMember extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    linkidin: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
